...
if [ $code_encrypt -eq 1 ]
 then
  ...
  wine ../../../../../../../tools/W805/wm_tool.exe -b ./"$ProjName"_enc_key_N.bin -o ./"$ProjName" -it $img_type -fc 0 -ra $run_img_pos -ih $run_img_header -ua $upd_img_pos -nh 0  -un 0
 else
  wine ../../../../../../../tools/W805/wm_tool.exe -b ./"$ProjName".bin -o ./"$ProjName" -it $img_type -fc 0 -ra $run_img_pos -ih $run_img_header -ua $upd_img_pos -nh 0  -un 0
fi
...
if [ $signature -eq 1 ]
 then
  ...
  wine ../../../../../../../tools/W805/wm_tool.exe -b ../../../../../../../tools/W805/W805_secboot.bin -o ../../../../../../../tools/W805/W805_secboot -it 0 -fc 0 -ra $sec_img_pos -ih $sec_img_header -ua $upd_img_pos -nh $run_img_header  -un 0    
...
if [ $zip_type -eq 1 ]
 then
  if [ $signature -eq 1 ]
   then
    wine ../../../../../../../tools/W805/wm_tool.exe -b ./"$ProjName"_sign.img -o ../../../../../../../bin/W805/"$ProjName"_sign -it $img_type -fc 1 -ra $run_img_pos -ih $run_img_header -ua $upd_img_pos -nh 0  -un 0
    mv ../../../../../../../bin/W805/"$ProjName"_sign_gz.img ../../../../../../../bin/W805/"$ProjName"_sign_ota.img
  else
   wine ../../../../../../../tools/W805/wm_tool.exe -b ../../../../../../../bin/W805/"$ProjName".img -o ../../../../../../../bin/W805/"$ProjName" -it $img_type -fc 1 -ra $run_img_pos -ih $run_img_header -ua $upd_img_pos -nh 0  -un 0
